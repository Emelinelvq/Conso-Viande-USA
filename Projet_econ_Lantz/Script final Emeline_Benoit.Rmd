...
### Prix du poulet : 
Contrairement à la tendance historique de déflation réelle soulignée par l'OCDE, nous testons ici un scénario de hausse tendancielle du prix réel du poulet. Cette hypothèse repose sur une augmentation durable des coûts de production (normes environnementales plus strictes, hausse du coût de la main-d'œuvre et des exigences de bien-être animal). Dans ce cadre, le poulet perd de sa compétitivité relative, ce qui pourrait freiner la demande globale de protéines et modifier l'arbitrage des ménages, même en cas de croissance économique favorable.
```{r, include = FALSE}
