...
### Prix du poulet : 
Conformément aux perspectives de l'OCDE-FAO (2025-2034), nous postulons une baisse tendancielle du prix réel du poulet.L'OCDE anticipe que les gains d'efficacité technique et l'amélioration de la génétique aviaire continueront de réduire les coûts de production réels. Cette compétitivité accrue du poulet influence l'arbitrage des ménages et soutient la demande globale de protéines, même en période de ralentissement économique.
```{r, include = FALSE}
...
generer_prev_data <- function(taux_pib) {
  ...
  for(i in 1:6) {
    ...
    # Hypothèse : Baisse réelle du prix du poulet de 1% par an
    poulet_futur[i] <- if(i==1) poulet_actuel + log(0.99) else poulet_futur[i-1] + log(0.99)
  }
